...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                connection = _a.sent();
                userRepository = connection.getRepository(Book_1.Book);
                ...
                app.post("/books", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                data = __assign(__assign({}, req.body), { id: (0, uuid_1.v4)() });
                                return [4 /*yield*/, userRepository.create(data)];
                            case 1:
                                book = _a.sent();
                                return [4 /*yield*/, userRepository.save(book)];
                            case 2:
                                results = _a.sent();
                ...
                app.put("/books/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                book = _a.sent();
                                return [4 /*yield*/, userRepository.merge(book, req.body)];
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, userRepository.save(book)];
                            case 3:
                ...
                app.delete("/books/:id", function (req, res) {
                    var results = userRepository.delete(req.params.id);
